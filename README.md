...
# 3. 문제해결 전략
1. 과제를 처음 보고 살짝 당황했습니다. 사전 정보가 전혀 없었기에 그냥 알고리즘 같은 문제 나오지 않을까 예상했었는데 이렇게 소형 시스템을 개발하라고 할줄은...ㅎㅎ
